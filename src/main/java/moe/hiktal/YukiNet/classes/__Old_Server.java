...
//
//    public __Old_Server(String groupId, int groupIndex, int port, boolean isStatic) {
...
//    }
//
//    public __Old_Server Clone() {
//        __Old_Server ret = new __Old_Server(groupId, groupIndex, port, isStatic);
//        ret.cwd = cwd;
//        ret.config = config;
//        return ret;
//    }
...
//                            @Override
//                            public void run() {
//                                __Old_Server.this.procHandle = procHandle;
